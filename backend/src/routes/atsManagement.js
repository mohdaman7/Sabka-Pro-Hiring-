...
router.patch('/applications/:id/assign-hr', authenticate, authorizeRoles('admin', 'hr'), atsController.assignHRToApplication);
router.post('/applications/bulk-update', authenticate, authorizeRoles('admin', 'hr'), atsController.bulkUpdateApplications);
...
router.post('/interviews', authenticate, authorizeRoles('admin', 'hr', 'employer'), atsController.createInterview);
...
router.get('/reports/hr-performance', authenticate, authorizeRoles('admin'), atsController.getHRPerformanceReport);
