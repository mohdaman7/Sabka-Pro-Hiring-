        ...
        {!isCollapsed && (
          <div className="relative p-4 border-b border-white/10">
            ...
            >
              ...
              <Zap className="relative h-4 w-4 group-hover:scale-125 transition-transform duration-300" />
            </Link>
          </div>
        )}
        ...
        {isCollapsed && (
          <div className="relative p-3 border-b border-white/10">
            ...
            >
              ...
              ></div>
              <Plus className="relative h-6 w-6 text-white group-hover:rotate-90 transition-transform duration-300" />
            </Link>
          </div>
        )}
