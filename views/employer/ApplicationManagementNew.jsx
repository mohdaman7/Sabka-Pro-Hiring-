...
const STATUS_CONFIG = {
  applied: { label: "New", color: "bg-blue-500", icon: Sparkles, gradient: "from-blue-500 to-cyan-500" },
  reviewed: { label: "Reviewed", color: "bg-cyan-500", icon: Eye, gradient: "from-cyan-500 to-teal-500" },
  interview: { label: "Interview", color: "bg-purple-500", icon: Calendar, gradient: "from-purple-500 to-pink-500" },
  hired: { label: "Hired", color: "bg-green-500", icon: Award, gradient: "from-green-500 to-emerald-500" },
  rejected: { label: "Rejected", color: "bg-red-500", icon: XCircle, gradient: "from-red-500 to-rose-500" },
};
...
export default function ApplicationManagementNew() {
  ...
  const filtered = useMemo(() => {
    ...
    result.sort((a, b) => {
      ...
      if (sortBy === "name") return (a.studentId?.firstName || "").localeCompare(b.studentId?.firstName || "");
      return 0;
    });
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-white/60 text-sm md:text-base">Track and manage all candidate applications</p>
            </div>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-sm font-semibold ${isActive ? "text-white" : "text-white/60"}`}>{stat.label}</p>
                </button>
              );
            })}
          </div>
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-white/60 font-medium">Loading applications...</p>
            </div>
          </div>
        ) : filtered.length === 0 ? (
...
function ApplicationCard({ application, openMenuId, setOpenMenuId, onScheduleInterview, onManageInterview, onHire, onStatusUpdate }) {
        ...
        <div className="flex items-start gap-4 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 mb-2 flex-wrap">
              ...
              <span className={`px-3 py-1 rounded-lg text-xs font-bold text-white ${statusConfig.color} flex items-center gap-1.5`}>
          ...
          {isMenuOpen && (
            <>
              ...
              <div className="absolute right-0 top-12 z-50 w-56 bg-slate-900/95 backdrop-blur-xl border border-purple-500/30 rounded-xl shadow-2xl overflow-hidden">
                ...
                {["applied", "reviewed", "interview"].includes(application.status) && (
                  <button
                    onClick={() => {
                      onScheduleInterview();
                      setOpenMenuId(null);
                  ...
                  >
                    ...
                    <span className="font-medium">{application.hasInterview ? "Update Interview" : "Schedule Interview"}</span>
                  </button>
                )}
                ...
                <div className="px-2 py-2">
                  <p className="px-2 py-1 text-xs font-semibold text-white/40 uppercase">Change Status</p>
