            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-[#b87bd1]/30 transition-all"
                >
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center bg-${stat.color}-500/20`}
                    >
            ...
            <div className="space-y-4">
              ...
              <div className="w-full bg-white/10 rounded-full h-4 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${analytics?.overview.profileStrength || 0}%`,
                  }}
                />
              </div>
                  ...
                  analytics.videos.slice(0, 5).map((video, index) => (
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-white/60 text-sm">
                          {video.views} views · {video.uniqueViewers} unique
                        </div>
                      </div>
                    </div>
                  ))
