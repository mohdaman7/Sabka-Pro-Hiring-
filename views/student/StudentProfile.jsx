...
import { 
  User, Mail, Phone, GraduationCap, Briefcase, MapPin, 
  Upload, Save, Camera, Award, CheckCircle, 
  FileText, Target, TrendingUp, Crown
} from "lucide-react"
    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-white/90">Complete your profile to get better job matches</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-md hover:shadow-lg transition-all">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600">Complete your profile to unlock more opportunities</p>
          </div>
          <div className="text-right">
            <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
              75%
            </div>
            <p className="text-xs text-gray-600">Almost there!</p>
          </div>
        </div>
        <div className="w-full bg-gray-200 rounded-full h-3">
          <div 
            className="bg-gradient-to-r from-blue-600 to-cyan-600 h-3 rounded-full transition-all duration-500 shadow-md"
            style={{ width: '75%' }}
          ></div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-md hover:shadow-lg transition-all">
            ...
            <div className="flex flex-col items-center">
              <div className="relative group">
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-600 to-cyan-600 flex items-center justify-center text-white text-4xl font-bold shadow-xl ring-4 ring-blue-100 overflow-hidden">
                  {profileImage ? (
                ...
                <label className="absolute bottom-0 right-0 w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center cursor-pointer shadow-lg hover:bg-blue-700 transition-all hover:scale-110">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="text-right">
                    <span className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">₹999</span>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-8 shadow-md">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-6 border-t border-gray-200">
              ...
              <button
                className="px-6 py-4 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-semibold transition-all border border-gray-300"
              >
                Cancel
              </button>
            </div>
