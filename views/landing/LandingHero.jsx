...
export default function LandingHero() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0f172a] text-white">
      ...
      {/* Hero Content */}
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-44 pb-24">
        <div className="grid lg:grid-cols-[1.5fr_1fr] gap-8 items-start">
          {/* Left Column - Main Card */}
          <div className="bg-gradient-to-br from-gray-50 via-white to-blue-50/30 rounded-3xl p-16 shadow-2xl relative overflow-hidden min-h-[600px] flex flex-col justify-center border border-blue-100/50">
            ...
            <div className="relative z-10">
              ...
              {/* Heading */}
              <h1 className="text-6xl lg:text-7xl font-bold text-gray-900 leading-tight mb-10">
                Book Your Seats<br />NOW
              </h1>
          ...
          <div className="space-y-4 h-full flex flex-col">
            ...
            <Link
              ...
              className="group block rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 relative border border-white/10"
              style={{ flex: '2' }}
            >
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <h3 className="text-2xl font-bold text-white mb-2">Welcome to the Employee Portal</h3>
                <button className="bg-white text-gray-900 px-6 py-2 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-all duration-200">
                  Click Here
                </button>
              </div>
            </Link>
            ...
            <Link
              ...
              className="group block bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-700 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] flex flex-col justify-center border border-purple-400/20 relative overflow-hidden"
              style={{ flex: '1' }}
            >
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-pink-400 to-pink-600 border-4 border-purple-600"></div>
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 border-4 border-purple-600"></div>
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 border-4 border-purple-600"></div>
                </div>
                <span className="text-white font-medium text-lg">+56 mentors</span>
              </div>
            </Link>
          </div>
        </div>
