...
export default function LandingTestimonials() {
  ...
  const testimonials = [
    {
      ...
      content:
        "Sabka Pro HIRING helped me land my dream job in just 2 weeks. The training courses were excellent and the support team was always there to help.",
      rating: 5,
      gradient: "from-purple-600/95 to-fuchsia-700/95",
    },
    {
      name: "Rajesh Kumar",
      role: "HR Manager",
      ...
      rating: 5,
      gradient: "from-indigo-600/95 to-purple-700/95",
    },
    {
      name: "Anita Desai",
      ...
      rating: 5,
      gradient: "from-fuchsia-600/95 to-pink-700/95",
    },
    {
      name: "Vikram Singh",
      ...
      content:
        "The platform's AI matching is incredible. It connected me with roles that perfectly matched my skills and career aspirations.",
      rating: 5,
      gradient: "from-violet-600/95 to-purple-700/95",
    },
  ];
  ...
  const handlePrevious = () => {
    setCurrentIndex((prev) => {
      ...
      return newIndex < 0
        ? Math.max(0, testimonials.length - cardsPerPage)
        : newIndex;
    });
  };
