...
//         <div>
//           <h1 className="text-3xl font-bold text-slate-900 mb-2">Job Postings Management</h1>
//           <p className="text-slate-600">Manage all job postings across the platform</p>
//         </div>
//       </div>
...
//         {(activeTab === "all" ? jobs : jobs.filter((j) => j.status.toLowerCase() === activeTab)).map((job) => (
//           <div
//             key={job.id}
...
//                   <span className="font-semibold text-slate-900">{job.applications}</span> applications
//                 </span>
//                 <span className="text-slate-600">
//                   <span className="font-semibold text-slate-900">{job.views}</span> views
//                 </span>
//                 <span className="text-slate-600">
//                   Assigned to: <span className="text-slate-900">{job.assignedTo}</span>
//                 </span>
//               </div>
