    ...
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-purple-950 to-slate-950 flex items-center justify-center p-4">
      ...
      >
        <div className="grid lg:grid-cols-5 h-full">
          {/* Sidebar - Full height */}
          <div className="lg:col-span-2 bg-linear-to-br from-blue-600/20 to-cyan-600/20 p-8 border-r border-white/10 flex flex-col">
              ...
              >
                ...
                {step === 1 && (
                  <>
                    ...
                    <motion.button
                      ...
                      disabled={loading}
                      className="w-full py-4 bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl font-bold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-lg"
                    >
                      {loading ? (
                        <>
                ...
                {step === 2 && (
                  <>
                    ...
                    >
                      <div className="w-20 h-20 bg-linear-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                ...
                {step === 3 && (
                  <>
                    ...
                    <motion.button
                      ...
                      type="submit"
                      disabled={loading}
                      className="w-full py-5 bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl font-bold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-xl"
                    >
                      {loading ? (
                        <>
